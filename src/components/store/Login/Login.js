                                  ...
                                  <h3>Get more things done with Manilla checkout.</h3>
                                    ...
                                    <form>
                                        ...
                                        {/* <div class="form-button">
                                            <button id="submit" type="submit" style={{color: "#23466F"}} class="ibtn"> <i className="fa fa-sign-in-alt"></i> Login</button> <Link to="/business/forgot-password">Forgot password?</Link>
                                        </div> */}
                                    </form>
                                        <div class="form-button">
                                            <Link to="/business/dashboard/statistics/today-stat" style={{color: "#23466F"}} class="ibtn"> <i className="fa fa-sign-in-alt"></i> Login</Link> <Link to="/business/forgot-password">Forgot password?</Link>
                                        </div>
                                    
                                    <div class="other-links">
                                        <span>Not a member? </span><Link to="/business/register">Click to register</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card card-lock text-center">    
                                            <form>
                                                ...
                                                {/* <div class="card-footer ">
                                                    <button class="btn btn-round btn-lg" style={{backgroundColor: "#23466F"}}><i className="fa fa-sign-in-alt"></i> Login</button> <Link to="/business/forgot-password">Forgot password?</Link>
                                                </div> */}
                                                <div class="card-footer ">
                                                    <Link to="/business/dashboard/statistics/today-stat" class="btn btn-round btn-lg" style={{backgroundColor: "#23466F"}}><i className="fa fa-sign-in-alt"></i> Login</Link> <Link to="/business/forgot-password">Forgot password?</Link>
                                                </div>
                                            </form>
